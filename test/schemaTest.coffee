...
describe 'Setting up a schema', ->
  ...
  ## CASE 2
  describe 'Using an Object correctly', ->
    # setup
    userSchema =
      age :
        type: "Person.Age"
  ...
  ## CASE 3
  describe 'Using an Object as a subclass', ->
    # setup
    userSchema =
      name:
        first: 'Person.First'
  ...
  ## CASE 5
  describe 'Using an Object with other attributes', ->
    # setup
    userSchema =
      age :
        type: "Person.Age"
    ...
    # assert
    it "expect mixed object to pass and allow attributes to be validated", ->
      expect(user.type).toBe('Schema')
      expect(user.age.type).toBe('Person.Age')
    ...
    ## CASE 6
  describe 'Using a parent should throw error', ->
    # setup
    userSchema =
      age : "Person"
    ...
    # assert
    it "expect mixed object to pass and allow attributes to be validated", ->
      expect( -> new Schema(userSchema) ).toThrow()
